<template>
    <nav class="flex items-center justify-between h-32">
        ...
        <div class="items-center hidden gap-10 md:flex">
            ...
            <a class="font-medium text-white" href="#trickortreat">Trick or Treat</a>
            <button class="px-8 py-3 text-lg font-bold text-white rounded-full bg-secondary">Donate</button>
        </div>
    </nav>
</template>
